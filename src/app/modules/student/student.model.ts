...
const guardianSchema = new Schema<TGuardian>({
  fatherName: {
    ...
    validate: {
      ...
      message:
        "Father's name must be 2-50 characters long and contain only letters and spaces",
    },
  },
  fatherOccupation: {
    type: String,
  ...
  fatherContactNo: {
    ...
    validate: {
      ...
      message:
        'Please provide a valid Bangladeshi phone number (11 digits starting with 01)',
    },
  },
  motherName: {
    type: String,
    ...
    validate: {
      ...
      message:
        "Mother's name must be 2-50 characters long and contain only letters and spaces",
    },
  },
  motherOccupation: {
    type: String,
